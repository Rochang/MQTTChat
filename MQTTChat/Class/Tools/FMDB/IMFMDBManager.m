...
- (void)updateConversation:(IMModel *)model {
    [self isDataExistsInTable:kConversationTableName key:IMConversationModel.dbkey_sessionId value:[model oppositeId] completed:^(BOOL flag, FMResultSet * _Nonnull result) {
